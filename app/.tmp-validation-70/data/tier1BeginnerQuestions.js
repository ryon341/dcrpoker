...
exports.tier1BeginnerQuestions = void 0;
exports.getTier1ByLevel = getTier1ByLevel;
exports.getTier1ByCategory = getTier1ByCategory;
function makeActionQuestion(level, idx, seed) {
    return {
        ...
        explanation: seed.correctAction === 'raise'
...
function makeMathQuestion(level, idx, category, seed) {
    return {
...
const level1EvSeeds = [
    ...
    { prompt: 'You need 25% equity to call. Your hand has 30% equity. Is calling profitable?', choices: ['Yes', 'No', 'Break-even', 'Only in position'], correctAnswer: 'Yes', explanation: '30% is above 25%, so the call is +EV.', tags: ['l1', 'ev', 'compare'], difficultyScore: 13 },
    { prompt: 'You need 33% equity to call. Your hand has 28% equity. Is calling profitable?', choices: ['Yes', 'No', 'Break-even', 'Only multiway'], correctAnswer: 'No', explanation: '28% is below the required 33%, so folding is better.', tags: ['l1', 'ev', 'compare'], difficultyScore: 13 },
...
function buildLevel(level, actionSeeds, outsSeeds, evSeeds) {
    return [
...
exports.tier1BeginnerQuestions = [
...
function getTier1ByLevel(level) {
    return exports.tier1BeginnerQuestions.filter((q) => q.level === level);
}
function getTier1ByCategory(category) {
    return exports.tier1BeginnerQuestions.filter((q) => q.category === category);
}
